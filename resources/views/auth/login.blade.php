	...
	<body id="kt_body" class="bg-body">
		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="d-flex flex-column flex-lg-row flex-column-fluid">
				<!--begin::Aside-->
				<div class="d-flex flex-column flex-lg-row-auto w-xl-600px positon-xl-relative" style="background-color: #273a75">
					<!--begin::Wrapper-->
					<div class="d-flex flex-column position-xl-fixed top-0 bottom-0 w-xl-600px scroll-y">
						...
						<div class="d-flex flex-row-fluid flex-column text-center p-10 pt-lg-20">
							...
							<a href="../../demo10/dist/index.html" class="py-9 mb-5">
								<img alt="Logo" src="{{ url('/assets') }}/media/logos/gopal.png" class=""" />
							</a>
							<!--end::Logo-->
							<!--begin::Title-->
							<h1 class="fw-bolder fs-2qx pb-5 pb-md-10" style="color:yellow;">Welcome to Gopal Snack</h1>
							<!--end::Title-->
							<!--begin::Description-->
							<p class="fw-bold fs-2" style="color: white;">Please Login To
							<br />Checkout Product Releases</p>
							<!--end::Description-->
						</div>
						<!--end::Content-->
						<!--begin::Illustration-->
						...
						<div class="w-lg-500px p-10 p-lg-15 mx-auto">
							...
							<form class="form w-100" id="kt_sign_in_form" method="POST" action="{{ route('login') }}">
								...
								<div class="text-center mb-10">
									<!--begin::Title-->
									<h1 class="text-dark mb-3">Log In to Portal</h1>
									<!--end::Title-->
									<!--begin::Link-->
								...
								<div class="fv-row mb-10">
									...
									<!--end::Label-->
									<!--begin::Input-->
									<input class="form-control form-control-lg form-control-solid @error('email') is-invalid @enderror" type="text" name="email" autocomplete="off" autofocus/>
									@error('email')
