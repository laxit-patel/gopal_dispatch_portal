...
<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 pt-1">
    ...
    <li class="breadcrumb-item text-muted">Dealer</li>
...
<div class="post d-flex flex-column-fluid" id="kt_post">
    ...
    <div id="kt_content_container" class="container-xxl">
        <!--begin::Card-->
        <div class="card card-stretch card-scroll">
            <!--begin::Card header-->
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                        ...
                        <!--end::Export-->
                        <!--begin::Add user-->
                        <a href="{{ route('admin.dealer.create') }}" type="button" class="btn btn-primary">
            ...
            <div class="card-body pt-0">
                <!--begin::Table-->
                <table id="dealer_table" class="table table-row-bordered">
                    <thead>
