                ...
                <div class="col-md-4">
                    ...
                    <div class="card card-flush h-md-100">
                        ...
                        <div class="card-body pt-1">
                            <!--begin::Users-->
                            <div class="fw-bolder text-gray-600 mb-5">Total users with this role: {{ $role->count() }}</div>
                            <!--end::Users-->
                            <!--begin::Permissions-->
                        ...
                        <div class="card-footer flex-wrap pt-0">
                            <a href="{{ route('admin.role.edit',['id'=>$role->id]) }}" class="btn btn-light btn-active-primary my-1 me-2">Edit Role</a>
