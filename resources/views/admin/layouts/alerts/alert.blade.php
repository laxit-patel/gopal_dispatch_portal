...
<div class="alert alert-dismissible bg-success d-flex flex-column flex-sm-row mx-9 p-5 mb-10">
    <i class="fa fa-check-double text-white fs-3x my-auto me-5"></i>
    <!--begin::Content-->
    <div class="d-flex flex-column text-light pe-0 pe-sm-10">
        <h4 class="mb-2 text-light">Succes</h4>
...
<div class="alert alert-dismissible bg-primary d-flex flex-column flex-sm-row mx-9 p-5 mb-10">
    <!--begin::Icon-->
...
<div class="alert alert-dismissible bg-danger d-flex flex-column flex-sm-row mx-9 p-5 mb-10">
