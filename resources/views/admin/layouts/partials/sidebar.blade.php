        ...
        <div class="w-100 hover-scroll-overlay-y d-flex pe-2" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_footer, #kt_header" data-kt-scroll-wrappers="#kt_aside, #kt_aside_menu, #kt_aside_menu_wrapper" data-kt-scroll-offset="102">
            ...
            <div class="menu menu-column menu-rounded fw-bold" id="#kt_aside_menu" data-kt-menu="true">
                ...
                <a href="../../demo10/dist/index.html">
                    <img alt="Logo" src="{{ url('/assets') }}/media/logos/gopal.png" class="mx-auto d-none d-md-block h-100" />
                    <img alt="Logo" src="{{ url('/assets') }}/media/logos/gopal.png" class="mx-auto d-block d-md-none" />
                </a>
                                    ...
                                    <div class="menu-sub menu-sub-accordion">
                                        <div class="menu-item">
                                            <a class="menu-link" href="../../demo10/dist/apps/user-management/roles/list.html">
                                                ...
                                                <span class="menu-title">To Role</span>
                                            </a>
                                        </div>
                                        <div class="menu-item">
                                            <a class="menu-link" href="../../demo10/dist/apps/user-management/roles/view.html">
                                                ...
                                                <span class="menu-title">To User</span>
                                            </a>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="d-flex flex-stack">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="symbol symbol-circle symbol-40px">
                    <img src="{{ url('/assets') }}/media/logos/favicon.png" alt="admin profile pic" />
                </div>
                <!--end::Avatar-->
                <!--begin::User info-->
                <div class="ms-2">
